...
<meta name="Keywords" content="クラウド,ASP,EDI,EDIサービス,EOS,店舗システム,システム,開発,運用,宮崎,スーパー,食品スーパー,ハンディ,PDA,W-ZERO3,EOB,ISO27001,ひむか流通,流通ネットワーク,POS,ホームページ制作,web制作,ホームページ,Web,作成,HDN,HDNC,自動発注,流通BMS,生鮮" />
...
<!-- header　▲▲-->
<div id="slider">
		<div><a href="<?php bloginfo('url'); ?>/"><img src="<?php echo get_template_directory_uri(); ?>/images/slide08.jpg"></a></div>
